...
// Tri-license - WTFPL | MIT | BSD
 (function(global) {
        ...
        utils: {
            ...
            keys: function(obj) {
                ...
                function(obj) {
                    ...
                    key;
                    for (key in obj) {
                        if (keys.hasOwnProperty.call(obj, k)) {
                            keys.push(k);
                        }
                    }
                    return keys;
    ...
    //
    // Tri-license - WTFPL | MIT | BSD
    (function(global, doc, bpm, undef) {

        var docElement = doc.documentElement,
        sTimeout = global.setTimeout,
        ...
        isOpera = global.opera && toString.call(global.opera) == "[object Opera]",
        ...
        function injectCss(href, cb, attrs, timeout,
        /* Internal use */
        err, internal) {
                ...
                function handleGroup(needGroup, moreToCome) {
                    ...
                    // since the for-in does not preserve order. Arrays _should_ go in order though.
                        ...
                        needGroupSize = (function() {
                            var count = 0,
                            i;
                            for (i in bpm.utils.keys(needGroup)) {
                                count++;
                            }
                            return count;
                        })();
        ...
        bpm.load.executeStack = executeStack;
        bpm.load.injectJs = injectJs;
        bpm.load.injectCss = injectCss;

    })(global, global.document, bpm);
